...
PRIVATE int allocf(void)
{
	...
	for (i = 0; i < NR_FRAMES; i++)
	{
		...
		/* Local page replacement policy. - second chance */
	...
	/* Second chance things */
	if(frames[oldest].count > 0){
		// page is dereferenced
		frames[oldest].count = 0;
		// the page is inserted at the back of the queue -> not implemented yet 
	} else {
		/* Swap page out. */
